...
<ul>
  ...
  <li><a class="active" href="cell_chat.php">Cell Chat</a></li>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   ...
   <h1>Signaling direction: <br></h1><select id="caf" style="width:100%;" name="caftype" input type="text">
	<!--
	...
	-->
	<option value="Incoming" <?php if (@$_POST['caftype']=="Incoming"){echo "selected";}?>>Incoming</option>
	<option value="Outgoing" <?php if (@$_POST['caftype']=="Outgoing"){echo "selected";}?>>Outgoing</option>
	</select><br>
...
<?php $filedir = $head . "data" . "/" . $cancer. "/" . $caftype . "/" . $samples .  "/" . "cell_chat.pdf";?>
