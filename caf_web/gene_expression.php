...
<ul>
  ...
  <li><a class="active" href="gene_expression.php">Expression</a></li>
...
<?php $caftype = "\"" . $caftype . "\"";?>
<h4><?php
        if(!empty($_POST['caftype'])){system("sudo ./rscp/sdit.sh $cancer $caftype");}?></h4>
<?php $filedir = $head . "data" . "/" . $cancer. "/" . $caftype . "/" . $samples . "/" . $markers . "/" . "embedding.pdf";?>

<h2 style="margin:0;padding:0;"><a href="./rscp/dit.pdf#page=1" width="90%" height="85%" target="pdf">
