...
<ul>
  ...
  <li><a class="active" href="distribution.php">Distribution</a></li>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   ...
   <br><br><input id="IDsubmit" type="submit" style="width:80%;" name="submit" value="Submit" > <br>
</form>
</div>

<div id="showpdf" style="overflow:hidden;height:600px;width:60%;float:right;background-color:#f1f1f1;">
<?php $caftype = "\"" . $caftype . "\"";?>
<h4><?php if(!empty($_POST['caftype'])){system("sudo ./rscp/sGA.sh $cancer $caftype");}?></h4>
<?php $filedir = $head . "data" . "/" . $cancer. "/" . $caftype . "/" . $samples . "/" . $markers . "/" . "embedding.pdf";?>

<h2 style="margin:0;padding:0;"><a href="./rscp/GA.pdf#page=1" width="90%" height="85%" target="pdf">
